...
namespace MiniClinicManagementSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260414153219_ChangeApplicationUserEntity")]
    partial class ChangeApplicationUserEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MiniClinicManagementSystem.Core.Entities.Appointment", b =>
                {
                    b.HasOne("MiniClinicManagementSystem.Core.Entities.Doctor", "Doctor")
                        .WithMany("Appointments")
                        .HasForeignKey("DoctorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MiniClinicManagementSystem.Core.Entities.Patient", "Patient")
                        .WithMany("Appointments")
            ...
            modelBuilder.Entity("MiniClinicManagementSystem.Core.Entities.Doctor", b =>
                {
                    b.HasOne("MiniClinicManagementSystem.Core.Entities.Person", "Person")
                        .WithOne("Doctor")
                        .HasForeignKey("MiniClinicManagementSystem.Core.Entities.Doctor", "PersonId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("MiniClinicManagementSystem.Core.Entities.Patient", b =>
                {
                    b.HasOne("MiniClinicManagementSystem.Core.Entities.Person", "Person")
                        .WithOne("Patient")
                        .HasForeignKey("MiniClinicManagementSystem.Core.Entities.Patient", "PersonId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
